                        ...
                        <div class="col-xs-4">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <select class="select2" data-placeholder="Lựa chọn kiểu văn bản..." data-minimum-results-for-search="Infinity"
                                        style="width:100%" required="" id="type_dc" name="type" onchange="set_numberdc(this.value)">
