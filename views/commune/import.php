<div class="modal-header no-padding">
    <div class="table-header">
        Import danh sách xã / phường :: File excel
    </div>
</div>
<div class="modal-body">
    <div class="row">
        <form id="fm-imp-commune" method="post" enctype="multipart/form-data">
            <div class="col-xs-12">
...
<div class="modal-footer">
    ...
    <button class="btn btn-sm btn-primary pull-right" onclick="save_imp_commune()">
