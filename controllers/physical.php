...
class Physical extends Controller{
    ...
    function json(){
        ...
        $this->view->render('physical/json');
    }
    ...
    function update(){
        ...
        $this->view->render("physical/update");
    }
    ...
    function form(){
        ...
        $this->view->render('physical/form');
    }
}
?>
