<?php
class Document_cate_in extends Controller{
    ...
    function add(){
        ...
        $this->view->render("document_cate_in/add");
    }
    ...
    function del(){
        ...
        $this->view->render("document_cate_in/del");
    }
    ...
    function data_edit(){
        ...
        $this->view->render('document_cate_in/data_edit');
    }
}
?>
