...
class District extends Controller{
    ...
    function json(){
        ...
        $this->view->render('district/json');
    }

    function add(){
        $title = $_REQUEST['title']; $code = $_REQUEST['code']; $code_province = $_REQUEST['code_province'];
        if($this->model->dupliObj(0, $code) > 0){
            $jsonObj['msg'] = "Mã quận / huyện đã tồn tại";
            $jsonObj['success'] = false;
            $this->view->jsonObj = json_encode($jsonObj);
        }else{
            $data = array("title" => $title, "code" => $code, "code_province" => $code_province);
    ...
    function update(){
        ...
        $this->view->render("district/update");
    }
    ...
    function form(){
        ...
        $this->view->render('district/form');
    }

    function import(){
        $this->view->render('district/import');
    }
    ///////////////////////////////////////////////////////////////////////////////////////////////////
    function do_import(){
        try{
            ...
            for ($i = 2; $i <= $Totalrow; $i++) {
                ...
                $data = array("code" => $code, 'title' => $title, "code_province" => $code_province);
        ...
        $this->view->render('district/do_import');
    }
}
?>
